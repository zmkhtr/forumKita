...
public class ThreadFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.recyclerThread);
    ...
    private void getListData(){
        ...
        Call<Post> call = apiInterface.getPostUser("Bearer " + sessionManager.getUserToken());
        call.enqueue(new Callback<Post>() {
            ...
            public void onResponse(Call<Post> call, Response<Post> response) {
                ...
                if (dataPosts.isEmpty()){
                    Toast.makeText(getContext(), "You Don't Have Post Yet", Toast.LENGTH_SHORT).show();
                }
